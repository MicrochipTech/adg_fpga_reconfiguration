...
void dp_display_urow(void)
{
    ...
    {
        case IEEE1532_PM:
        dp_display_text((DPCHAR*)"IEEE1532");
        break;
        case STAPL_PM:
        dp_display_text((DPCHAR*)"STAPL");
        break;
        case DIRECTC_PM:
        dp_display_text((DPCHAR*)"DIRECTC");
        break;
        case PDB_PM:
        dp_display_text((DPCHAR*)"PDB");
        break;
        case SVF_PM:
        dp_display_text((DPCHAR*)"SVF");
        break;
        case IAP_PM:
        dp_display_text((DPCHAR*)"IAP");
        break;
        default:
        dp_display_text((DPCHAR*)"Unknown");
        break;
    };
    dp_display_text((DPCHAR*)"\r\nAlgorithm Version: = ");
    ...
    {
        case FP:
        dp_display_text((DPCHAR*)"Flash Pro");
        break;
        case FPLITE:
        dp_display_text((DPCHAR*)"Flash Pro Lite");
        break;
        case FP3:
        dp_display_text((DPCHAR*)"FP3");
        break;
        case SCULPTW:
        dp_display_text((DPCHAR*)"Sculptor");
        break;
        case BPW:
        dp_display_text((DPCHAR*)"BP Programmer");
        break;
        case DIRECTCP:
        dp_display_text((DPCHAR*)"DirectC");
        break;
